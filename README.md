...
자신의 도메인이 서버의 IP를 가리키게 해주세요. 네임서버 셋팅에서 설정할 수 있습니다.

멀티 사이트 설명이므로 `도메인`, `www.도메인`, `rhymix.도메인`, `wp.도에인`, `port.도메인`, `pma.도메인` 총 6개의 도메인을 셋팅하면 됩니다.
...
| A | wp | 123.123.123.123 |
| A | rhymix | 123.123.123.123 |
